...
PIPELINE_JOB_SUBMISSION_SERVICE_IMAGE="us-central1-docker.pkg.dev/mdepew-assets/xgboost-classification-artifact-registry/xgboost-classification/submission_service:latest"
...
SOURCE_REPO_NAME="xgboost-classification-repository"
